...
<div class="slides">
    ...
    <div class="slide">
        <div class="content-2">
            <div class="text-container">
                <h2>Kto produkuje najwięcej śmieci?</h2>
                <p>Liczba produkowanych odpadów wciąż rośnie. Szacuje się, że w Europie przeciętny człowiek rocznie produkuje ich 486 kg. Oto negatywne przykłady Państw na naszym kontynencie (dane z 2020 roku):</p>
                <p>Dania – 781 kg na osobę,</p>
                <p>Cypr – 637 kg na osobę,</p>
                <p>Niemcy – 633 kg na osobę,</p>
                <p>Szwecja – 706 kg na osobę,</p>
                <p>Islandia – 656 kg na osobę.</p>
    ...
    <div class="slide">
        <div class="content-6">
            <div class="nav">
                <h1>Jak segregować, aby umożliwić <br>recykling?</h1>
            </div>
